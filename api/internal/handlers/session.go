...
type sessionService interface {
	Create(ownerID string) (*domain.ChatSession, error)
	Join(sessionID, userID string) error
	AddMessage(sessionID string, msg domain.Message) error
	GetMessages(sessionID string, since time.Time) ([]domain.Message, error)
}
...
func NewSessionHandler(sessions sessionService, rag domain.RAGEngine) *SessionHandler {
